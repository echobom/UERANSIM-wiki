...
- **gtpAdvertiseIp:** If you want to separate GTP listening address and DL TL address you can set this value to override "Downlink User-Plane Transport Layer Address" which is advertised to UPF. This field is optional and **not** required for most of the people. It is especially useful in case of a NAT between gNB and UPF. We didn't include this field in the sample config files.
