...
- **uacAcc:** Unified Access Control (UAC), Access Control Class (ACC) shall be configured in this field. `normalClass` takes the value in range `[0, 9]`, and the classes from `11` to `15` are for high priority access. See [TS 31.102](https://www.etsi.org/deliver/etsi_ts/131100_131199/131102/15.11.00_60/ts_131102v151100p.pdf) for UAC ACC configurations.
